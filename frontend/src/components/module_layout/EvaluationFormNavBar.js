...
import LoadingOverlay from "../module_feedback/QuickLoadingOverlay"; // Assuming you have this file for a quick loader

export default function EvaluationFormNavBar() {
  ...
  const handleYes = () => {
    ...
    // Simulate a short delay for loading and then navigate to the specific route
    setTimeout(() => {
      // Use the absolute path '/home' to always return to the home page
      navigate('/home');
    }, 1500);
  };
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-blue-800 text-white p-4 flex justify-between items-center rounded-b-md">
        <h1 className="font-bold text-lg">Evaluate an Instructor</h1>
        <button
